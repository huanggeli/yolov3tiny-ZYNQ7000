...
(* CORE_GENERATION_INFO="hls_preprocess,hls_ip_2017_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z035ffg676-2,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=6.802000,HLS_SYN_LAT=926643,HLS_SYN_TPT=926644,HLS_SYN_MEM=2,HLS_SYN_DSP=0,HLS_SYN_FF=572,HLS_SYN_LUT=1917}" *)

module hls_preprocess (
...
wire    Convert_U0_ap_done;
wire    Convert_U0_ap_continue;
wire    Convert_U0_ap_idle;
wire    Convert_U0_ap_ready;
wire    Convert_U0_start_out;
wire    Convert_U0_start_write;
wire    Convert_U0_src_data_stream_0_V_read;
wire    Convert_U0_src_data_stream_1_V_read;
wire    Convert_U0_src_data_stream_2_V_read;
wire    Convert_U0_src_data_stream_3_V_read;
wire   [7:0] Convert_U0_dst_data_stream_0_V_din;
wire    Convert_U0_dst_data_stream_0_V_write;
wire   [7:0] Convert_U0_dst_data_stream_1_V_din;
wire    Convert_U0_dst_data_stream_1_V_write;
wire   [7:0] Convert_U0_dst_data_stream_2_V_din;
wire    Convert_U0_dst_data_stream_2_V_write;
wire   [7:0] Convert_U0_dst_data_stream_3_V_din;
wire    Convert_U0_dst_data_stream_3_V_write;
...
wire   [0:0] start_for_Convert_U0_din;
wire    start_for_Convert_U0_full_n;
wire   [0:0] start_for_Convert_U0_dout;
wire    start_for_Convert_U0_empty_n;
...
hls_preprocess_AXILiteS_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_AXILITES_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_AXILITES_DATA_WIDTH ))
hls_preprocess_AXILiteS_s_axi_U(
...
fifo_w8_d1_A src_img_data_stream_s_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A src_img_data_stream_1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A src_img_data_stream_2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A src_img_data_stream_3_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A dst_img_data_stream_s_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A dst_img_data_stream_1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A dst_img_data_stream_2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A dst_img_data_stream_3_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A ifm_img_data_stream_s_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A ifm_img_data_stream_1_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A ifm_img_data_stream_2_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w8_d1_A ifm_img_data_stream_3_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign Convert_U0_ap_continue = 1'b1;

assign Convert_U0_ap_start = start_for_Convert_U0_empty_n;
...
assign ap_idle = (Mat2AXIvideo_U0_ap_idle & Downsample_U0_ap_idle & Convert_U0_ap_idle & AXIvideo2Mat_U0_ap_idle);
...
assign start_for_Convert_U0_din = 1'b1;
