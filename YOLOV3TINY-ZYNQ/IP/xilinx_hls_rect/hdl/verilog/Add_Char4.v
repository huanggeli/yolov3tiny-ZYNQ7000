...
input  [15:0] ch4x_loc_dout;
input   ch4x_loc_empty_n;
output   ch4x_loc_read;
...
wire   [9:0] letter296_address0;
reg    letter296_ce0;
wire   [15:0] letter296_q0;
reg    src_data_stream_0_V_blk_n;
wire    ap_CS_fsm_pp0_stage0;
reg    ap_enable_reg_pp0_iter1;
wire    ap_block_pp0_stage0;
reg   [0:0] tmp_78_i_i_reg_815;
...
reg   [15:0] ch4x_loc_read_reg_761;
wire   [0:0] tmp_i_i_fu_498_p2;
reg   [0:0] tmp_i_i_reg_767;
wire   [16:0] tmp_cast_i_i_fu_504_p1;
reg   [16:0] tmp_cast_i_i_reg_772;
wire   [16:0] tmp_67_i_i_fu_508_p2;
reg   [16:0] tmp_67_i_i_reg_777;
wire   [10:0] tmp_23_cast_fu_518_p3;
reg   [10:0] tmp_23_cast_reg_782;
wire   [16:0] tmp_70_i_i_fu_530_p2;
reg   [16:0] tmp_70_i_i_reg_787;
wire   [9:0] i_fu_546_p2;
reg   [9:0] i_reg_795;
wire    ap_CS_fsm_state2;
wire   [0:0] tmp_71_i_i_fu_540_p2;
wire   [0:0] sel_tmp6_fu_608_p2;
reg   [0:0] sel_tmp6_reg_805;
reg   [15:0] p_Val2_s_reg_810;
wire    ap_CS_fsm_state3;
wire   [0:0] tmp_78_i_i_fu_618_p2;
wire    ap_block_state4_pp0_stage0_iter0;
reg    ap_block_state5_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [10:0] j_fu_624_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] tmp_38_fu_673_p3;
reg   [0:0] tmp_38_reg_824;
...
wire   [63:0] tmp_24_cast_fu_581_p1;
reg    ap_block_pp0_stage0_01001;
wire   [5:0] tmp_fu_514_p1;
wire   [16:0] tmp_69_cast107_i_i_fu_526_p1;
wire   [15:0] i_cast106_i_i_fu_536_p1;
wire   [16:0] tmp_74_cast_i_i_fu_557_p1;
wire   [16:0] tmp_75_i_i_fu_561_p2;
wire   [10:0] tmp_77_i_i_cast_fu_566_p4;
wire   [10:0] tmp_11_fu_576_p2;
wire   [0:0] ult_fu_586_p2;
wire   [0:0] rev8_fu_591_p2;
wire   [0:0] tmp25_fu_597_p2;
wire   [0:0] tmp_73_i_i_fu_552_p2;
wire   [0:0] sel_tmp6_demorgan_fu_602_p2;
wire   [15:0] j_cast105_i_i_fu_614_p1;
wire   [0:0] ult9_fu_630_p2;
wire   [16:0] tmp_82_cast_i_i_fu_641_p1;
wire   [15:0] tmp_84_i_i_fu_650_p2;
wire   [14:0] tmp_s_fu_655_p4;
wire  signed [15:0] xos_fu_665_p1;
wire   [31:0] bvh_d_index_fu_669_p1;
wire   [0:0] tmp_83_i_i_fu_645_p2;
wire   [0:0] tmp26_fu_680_p2;
wire   [0:0] rev_fu_635_p2;
wire   [7:0] markpix_val_0_3_fu_691_p3;
wire   [7:0] markpix_val_1_3_fu_697_p3;
wire   [7:0] markpix_val_2_3_fu_703_p3;
reg   [4:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (tmp_71_i_i_fu_540_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((color3_out_full_n == 1'b0) | (color2_out_full_n == 1'b0) | (color1_out_full_n == 1'b0) | (ytop_out_full_n == 1'b0) | (color3_empty_n == 1'b0) | (color2_empty_n == 1'b0) | (color1_empty_n == 1'b0) | (char4_empty_n == 1'b0) | (ytop_s_empty_n == 1'b0) | (ch4x_loc_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_i_i_reg_476 <= 10'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_78_i_i_fu_618_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if ((~((color3_out_full_n == 1'b0) | (color2_out_full_n == 1'b0) | (color1_out_full_n == 1'b0) | (ytop_out_full_n == 1'b0) | (color3_empty_n == 1'b0) | (color2_empty_n == 1'b0) | (color1_empty_n == 1'b0) | (char4_empty_n == 1'b0) | (ytop_s_empty_n == 1'b0) | (ch4x_loc_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ...
        tmp_23_cast_reg_782[10 : 5] <= tmp_23_cast_fu_518_p3[10 : 5];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_71_i_i_fu_540_p2 == 1'd0))) begin
        sel_tmp6_reg_805 <= sel_tmp6_fu_608_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_78_i_i_fu_618_p2 == 1'd0))) begin
...
always @ (*) begin
    if ((tmp_78_i_i_fu_618_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (tmp_71_i_i_fu_540_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_78_i_i_reg_815 == 1'd0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (tmp_78_i_i_reg_815 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((1'b0 == ap_block_pp0_stage0_subdone) & (tmp_78_i_i_fu_618_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((1'b0 == ap_block_pp0_stage0_subdone) & (tmp_78_i_i_fu_618_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((dst_data_stream_3_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_2_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_1_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_0_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_3_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_2_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_1_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_0_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((dst_data_stream_3_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_2_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_1_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_0_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_3_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_2_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_1_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_0_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0))));
end
...
always @ (*) begin
    ap_block_state1 = ((color3_out_full_n == 1'b0) | (color2_out_full_n == 1'b0) | (color1_out_full_n == 1'b0) | (ytop_out_full_n == 1'b0) | (color3_empty_n == 1'b0) | (color2_empty_n == 1'b0) | (color1_empty_n == 1'b0) | (char4_empty_n == 1'b0) | (ytop_s_empty_n == 1'b0) | (ch4x_loc_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_block_state4_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = (((dst_data_stream_3_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_2_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_1_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((dst_data_stream_0_V_full_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_3_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_2_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_1_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)) | ((src_data_stream_0_V_empty_n == 1'b0) & (tmp_78_i_i_reg_815 == 1'd0)));
end
...
assign dst_data_stream_0_V_din = ((sel_tmp7_reg_831[0:0] === 1'b1) ? markpix_val_0_3_fu_691_p3 : src_data_stream_0_V_dout);

assign dst_data_stream_1_V_din = ((sel_tmp7_reg_831[0:0] === 1'b1) ? markpix_val_1_3_fu_697_p3 : src_data_stream_1_V_dout);

assign dst_data_stream_2_V_din = ((sel_tmp7_reg_831[0:0] === 1'b1) ? markpix_val_2_3_fu_703_p3 : src_data_stream_2_V_dout);
...
assign letter296_address0 = tmp_24_cast_fu_581_p1;

assign markpix_val_0_3_fu_691_p3 = ((tmp_38_reg_824[0:0] === 1'b1) ? markpix_val_0_reg_746 : 8'd255);

assign markpix_val_1_3_fu_697_p3 = ((tmp_38_reg_824[0:0] === 1'b1) ? markpix_val_1_reg_751 : 8'd255);

assign markpix_val_2_3_fu_703_p3 = ((tmp_38_reg_824[0:0] === 1'b1) ? markpix_val_2_reg_756 : 8'd255);

assign rev8_fu_591_p2 = (ult_fu_586_p2 ^ 1'd1);

assign rev_fu_635_p2 = (ult9_fu_630_p2 ^ 1'd1);

assign sel_tmp6_demorgan_fu_602_p2 = (tmp_73_i_i_fu_552_p2 | tmp25_fu_597_p2);

assign sel_tmp6_fu_608_p2 = (sel_tmp6_demorgan_fu_602_p2 ^ 1'd1);

assign sel_tmp7_fu_685_p2 = (tmp26_fu_680_p2 & rev_fu_635_p2);

assign tmp25_fu_597_p2 = (tmp_i_i_reg_767 | rev8_fu_591_p2);

assign tmp26_fu_680_p2 = (tmp_83_i_i_fu_645_p2 & sel_tmp6_reg_805);

assign tmp_11_fu_576_p2 = (tmp_23_cast_reg_782 + tmp_77_i_i_cast_fu_566_p4);

assign tmp_23_cast_fu_518_p3 = {{tmp_fu_514_p1}, {5'd0}};

assign tmp_24_cast_fu_581_p1 = tmp_11_fu_576_p2;

assign tmp_38_fu_673_p3 = p_Val2_s_reg_810[bvh_d_index_fu_669_p1];

assign tmp_67_i_i_fu_508_p2 = (17'd64 + tmp_cast_i_i_fu_504_p1);

assign tmp_69_cast107_i_i_fu_526_p1 = ch4x_loc_dout;

assign tmp_70_i_i_fu_530_p2 = (17'd32 + tmp_69_cast107_i_i_fu_526_p1);

assign tmp_71_i_i_fu_540_p2 = ((i_i_i_reg_476 == 10'd720) ? 1'b1 : 1'b0);

assign tmp_73_i_i_fu_552_p2 = ((i_cast106_i_i_fu_536_p1 < ytop_read_reg_741) ? 1'b1 : 1'b0);

assign tmp_74_cast_i_i_fu_557_p1 = i_i_i_reg_476;

assign tmp_75_i_i_fu_561_p2 = (tmp_74_cast_i_i_fu_557_p1 - tmp_cast_i_i_reg_772);

assign tmp_77_i_i_cast_fu_566_p4 = {{tmp_75_i_i_fu_561_p2[11:1]}};

assign tmp_78_i_i_fu_618_p2 = ((j_i_i_reg_487 == 11'd1280) ? 1'b1 : 1'b0);

assign tmp_82_cast_i_i_fu_641_p1 = j_i_i_reg_487;

assign tmp_83_i_i_fu_645_p2 = ((tmp_82_cast_i_i_fu_641_p1 < tmp_70_i_i_reg_787) ? 1'b1 : 1'b0);

assign tmp_84_i_i_fu_650_p2 = (j_cast105_i_i_fu_614_p1 - ch4x_loc_read_reg_761);

assign tmp_cast_i_i_fu_504_p1 = ytop_s_dout;

assign tmp_fu_514_p1 = char4_dout[5:0];

assign tmp_i_i_fu_498_p2 = ((char4_dout == 8'd26) ? 1'b1 : 1'b0);

assign tmp_s_fu_655_p4 = {{tmp_84_i_i_fu_650_p2[15:1]}};

assign ult9_fu_630_p2 = ((j_cast105_i_i_fu_614_p1 < ch4x_loc_read_reg_761) ? 1'b1 : 1'b0);

assign ult_fu_586_p2 = ((tmp_74_cast_i_i_fu_557_p1 < tmp_67_i_i_reg_777) ? 1'b1 : 1'b0);
...
always @ (posedge ap_clk) begin
    ...
    tmp_23_cast_reg_782[4:0] <= 5'b00000;
end
