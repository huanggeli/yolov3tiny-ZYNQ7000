...
architecture behav of Add_Char4 is 
    ...
    signal tmp_78_i_i_reg_815 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_67_i_i_fu_508_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_67_i_i_reg_777 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_23_cast_fu_518_p3 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_23_cast_reg_782 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_70_i_i_fu_530_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_70_i_i_reg_787 : STD_LOGIC_VECTOR (16 downto 0);
    signal i_fu_546_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal i_reg_795 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal tmp_71_i_i_fu_540_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_78_i_i_fu_618_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state4_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state5_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal j_fu_624_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tmp_38_fu_673_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_38_reg_824 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_24_cast_fu_581_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal tmp_fu_514_p1 : STD_LOGIC_VECTOR (5 downto 0);
    signal tmp_69_cast107_i_i_fu_526_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal i_cast106_i_i_fu_536_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_74_cast_i_i_fu_557_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_75_i_i_fu_561_p2 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_77_i_i_cast_fu_566_p4 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_11_fu_576_p2 : STD_LOGIC_VECTOR (10 downto 0);
    signal ult_fu_586_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal rev8_fu_591_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp25_fu_597_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_73_i_i_fu_552_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_82_cast_i_i_fu_641_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal tmp_84_i_i_fu_650_p2 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal tmp_83_i_i_fu_645_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp26_fu_680_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal rev_fu_635_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal markpix_val_0_3_fu_691_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal markpix_val_1_3_fu_697_p3 : STD_LOGIC_VECTOR (7 downto 0);
    signal markpix_val_2_3_fu_703_p3 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_71_i_i_fu_540_p2 = ap_const_lv1_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_fu_618_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((color3_out_full_n = ap_const_logic_0) or (color2_out_full_n = ap_const_logic_0) or (color1_out_full_n = ap_const_logic_0) or (ytop_out_full_n = ap_const_logic_0) or (color3_empty_n = ap_const_logic_0) or (color2_empty_n = ap_const_logic_0) or (color1_empty_n = ap_const_logic_0) or (char4_empty_n = ap_const_logic_0) or (ytop_s_empty_n = ap_const_logic_0) or (ch4x_loc_empty_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                ch4x_loc_read_reg_761 <= ch4x_loc_dout;
                markpix_val_0_reg_746 <= color1_dout;
                markpix_val_1_reg_751 <= color2_dout;
                markpix_val_2_reg_756 <= color3_dout;
                    tmp_23_cast_reg_782(10 downto 5) <= tmp_23_cast_fu_518_p3(10 downto 5);
                tmp_67_i_i_reg_777 <= tmp_67_i_i_fu_508_p2;
                tmp_70_i_i_reg_787 <= tmp_70_i_i_fu_530_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_71_i_i_fu_540_p2 = ap_const_lv1_0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_fu_618_p2 = ap_const_lv1_0))) then
                sel_tmp7_reg_831 <= sel_tmp7_fu_685_p2;
                tmp_38_reg_824 <= tmp_38_fu_673_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                tmp_78_i_i_reg_815 <= tmp_78_i_i_fu_618_p2;
            end if;
        end if;
    end process;
    tmp_cast_i_i_reg_772(16) <= '0';
    tmp_23_cast_reg_782(4 downto 0) <= "00000";

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ch4x_loc_empty_n, ytop_s_empty_n, char4_empty_n, color1_empty_n, color2_empty_n, color3_empty_n, ytop_out_full_n, color1_out_full_n, color2_out_full_n, color3_out_full_n, ap_CS_fsm_state2, tmp_71_i_i_fu_540_p2, tmp_78_i_i_fu_618_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_71_i_i_fu_540_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
            ...
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (tmp_78_i_i_fu_618_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (tmp_78_i_i_fu_618_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(src_data_stream_0_V_empty_n, src_data_stream_1_V_empty_n, src_data_stream_2_V_empty_n, src_data_stream_3_V_empty_n, dst_data_stream_0_V_full_n, dst_data_stream_1_V_full_n, dst_data_stream_2_V_full_n, dst_data_stream_3_V_full_n, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((dst_data_stream_3_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_2_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_1_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_0_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_3_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_2_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_1_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_0_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(src_data_stream_0_V_empty_n, src_data_stream_1_V_empty_n, src_data_stream_2_V_empty_n, src_data_stream_3_V_empty_n, dst_data_stream_0_V_full_n, dst_data_stream_1_V_full_n, dst_data_stream_2_V_full_n, dst_data_stream_3_V_full_n, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (((dst_data_stream_3_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_2_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_1_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_0_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_3_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_2_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_1_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_0_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))));
    end process;
    ...
    ap_block_state5_pp0_stage0_iter1_assign_proc : process(src_data_stream_0_V_empty_n, src_data_stream_1_V_empty_n, src_data_stream_2_V_empty_n, src_data_stream_3_V_empty_n, dst_data_stream_0_V_full_n, dst_data_stream_1_V_full_n, dst_data_stream_2_V_full_n, dst_data_stream_3_V_full_n, tmp_78_i_i_reg_815)
    begin
                ap_block_state5_pp0_stage0_iter1 <= (((dst_data_stream_3_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_2_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_1_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((dst_data_stream_0_V_full_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_3_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_2_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_1_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)) or ((src_data_stream_0_V_empty_n = ap_const_logic_0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0)));
    end process;


    ap_condition_pp0_exit_iter0_state4_assign_proc : process(tmp_78_i_i_fu_618_p2)
    begin
        if ((tmp_78_i_i_fu_618_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, ap_CS_fsm_state2, tmp_71_i_i_fu_540_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_71_i_i_fu_540_p2 = ap_const_lv1_1))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, tmp_71_i_i_fu_540_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (tmp_71_i_i_fu_540_p2 = ap_const_lv1_1))) then 
    ...
    dst_data_stream_0_V_blk_n_assign_proc : process(dst_data_stream_0_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    dst_data_stream_0_V_din <= 
        markpix_val_0_3_fu_691_p3 when (sel_tmp7_reg_831(0) = '1') else 
        src_data_stream_0_V_dout;

    dst_data_stream_0_V_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    dst_data_stream_1_V_blk_n_assign_proc : process(dst_data_stream_1_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    dst_data_stream_1_V_din <= 
        markpix_val_1_3_fu_697_p3 when (sel_tmp7_reg_831(0) = '1') else 
        src_data_stream_1_V_dout;

    dst_data_stream_1_V_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    dst_data_stream_2_V_blk_n_assign_proc : process(dst_data_stream_2_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    dst_data_stream_2_V_din <= 
        markpix_val_2_3_fu_703_p3 when (sel_tmp7_reg_831(0) = '1') else 
        src_data_stream_2_V_dout;

    dst_data_stream_2_V_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    dst_data_stream_3_V_blk_n_assign_proc : process(dst_data_stream_3_V_full_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    dst_data_stream_3_V_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    letter296_address0 <= tmp_24_cast_fu_581_p1(10 - 1 downto 0);
    ...
    markpix_val_0_3_fu_691_p3 <= 
        markpix_val_0_reg_746 when (tmp_38_reg_824(0) = '1') else 
        ap_const_lv8_FF;
    markpix_val_1_3_fu_697_p3 <= 
        markpix_val_1_reg_751 when (tmp_38_reg_824(0) = '1') else 
        ap_const_lv8_FF;
    markpix_val_2_3_fu_703_p3 <= 
        markpix_val_2_reg_756 when (tmp_38_reg_824(0) = '1') else 
        ap_const_lv8_FF;
    rev8_fu_591_p2 <= (ult_fu_586_p2 xor ap_const_lv1_1);
    rev_fu_635_p2 <= (ult9_fu_630_p2 xor ap_const_lv1_1);
    sel_tmp6_demorgan_fu_602_p2 <= (tmp_73_i_i_fu_552_p2 or tmp25_fu_597_p2);
    sel_tmp6_fu_608_p2 <= (sel_tmp6_demorgan_fu_602_p2 xor ap_const_lv1_1);
    sel_tmp7_fu_685_p2 <= (tmp26_fu_680_p2 and rev_fu_635_p2);

    src_data_stream_0_V_blk_n_assign_proc : process(src_data_stream_0_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    src_data_stream_0_V_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    src_data_stream_1_V_blk_n_assign_proc : process(src_data_stream_1_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    src_data_stream_1_V_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    src_data_stream_2_V_blk_n_assign_proc : process(src_data_stream_2_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    src_data_stream_2_V_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    src_data_stream_3_V_blk_n_assign_proc : process(src_data_stream_3_V_empty_n, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, tmp_78_i_i_reg_815)
    begin
        if (((ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    src_data_stream_3_V_read_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, tmp_78_i_i_reg_815, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (tmp_78_i_i_reg_815 = ap_const_lv1_0))) then 
    ...
    tmp25_fu_597_p2 <= (tmp_i_i_reg_767 or rev8_fu_591_p2);
    tmp26_fu_680_p2 <= (tmp_83_i_i_fu_645_p2 and sel_tmp6_reg_805);
    tmp_11_fu_576_p2 <= std_logic_vector(unsigned(tmp_23_cast_reg_782) + unsigned(tmp_77_i_i_cast_fu_566_p4));
    tmp_23_cast_fu_518_p3 <= (tmp_fu_514_p1 & ap_const_lv5_0);
    tmp_24_cast_fu_581_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_11_fu_576_p2),64));
    tmp_38_fu_673_p3 <= p_Val2_s_reg_810(to_integer(unsigned(bvh_d_index_fu_669_p1)) downto to_integer(unsigned(bvh_d_index_fu_669_p1))) when (to_integer(unsigned(bvh_d_index_fu_669_p1))>= 0 and to_integer(unsigned(bvh_d_index_fu_669_p1))<=15) else "-";
    tmp_67_i_i_fu_508_p2 <= std_logic_vector(unsigned(ap_const_lv17_40) + unsigned(tmp_cast_i_i_fu_504_p1));
    tmp_69_cast107_i_i_fu_526_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ch4x_loc_dout),17));
    tmp_70_i_i_fu_530_p2 <= std_logic_vector(unsigned(ap_const_lv17_20) + unsigned(tmp_69_cast107_i_i_fu_526_p1));
    tmp_71_i_i_fu_540_p2 <= "1" when (i_i_i_reg_476 = ap_const_lv10_2D0) else "0";
    tmp_73_i_i_fu_552_p2 <= "1" when (unsigned(i_cast106_i_i_fu_536_p1) < unsigned(ytop_read_reg_741)) else "0";
    tmp_74_cast_i_i_fu_557_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_i_i_reg_476),17));
    tmp_75_i_i_fu_561_p2 <= std_logic_vector(unsigned(tmp_74_cast_i_i_fu_557_p1) - unsigned(tmp_cast_i_i_reg_772));
    tmp_77_i_i_cast_fu_566_p4 <= tmp_75_i_i_fu_561_p2(11 downto 1);
    tmp_78_i_i_fu_618_p2 <= "1" when (j_i_i_reg_487 = ap_const_lv11_500) else "0";
    tmp_82_cast_i_i_fu_641_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_i_i_reg_487),17));
    tmp_83_i_i_fu_645_p2 <= "1" when (unsigned(tmp_82_cast_i_i_fu_641_p1) < unsigned(tmp_70_i_i_reg_787)) else "0";
    tmp_84_i_i_fu_650_p2 <= std_logic_vector(unsigned(j_cast105_i_i_fu_614_p1) - unsigned(ch4x_loc_read_reg_761));
    tmp_cast_i_i_fu_504_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ytop_s_dout),17));
    tmp_fu_514_p1 <= char4_dout(6 - 1 downto 0);
    tmp_i_i_fu_498_p2 <= "1" when (char4_dout = ap_const_lv8_1A) else "0";
    tmp_s_fu_655_p4 <= tmp_84_i_i_fu_650_p2(15 downto 1);
    ult9_fu_630_p2 <= "1" when (unsigned(j_cast105_i_i_fu_614_p1) < unsigned(ch4x_loc_read_reg_761)) else "0";
    ult_fu_586_p2 <= "1" when (unsigned(tmp_74_cast_i_i_fu_557_p1) < unsigned(tmp_67_i_i_reg_777)) else "0";
